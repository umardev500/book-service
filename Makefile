...
update:
	grpcurl --plaintext -d '{"book_id": "1667832878734", "payload": {"title": "Lord of The Ring 29", "uploader": {"user": "steven"}, "editors": [{"user_id": "721872389238", "user": "mark"}]}}' localhost:5014 BookService.Update
